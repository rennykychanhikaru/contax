...
type AppRouteHandlerRoutes = "/api/agents" | "/api/agents/default" | "/api/appointments/book" | "/api/calendar/check-availability" | "/api/calendar/list" | "/api/calendar/slots" | "/api/calendar/status" | "/api/calendar/token" | "/api/google/oauth/callback" | "/api/google/oauth/start" | "/api/onboarding" | "/api/org/default" | "/api/realtime/token" | "/api/settings/twilio" | "/api/settings/webhook" | "/api/test-env" | "/api/webhook/[userId]/[token]" | "/api/webhook/agent/[token]/trigger" | "/api/webhook/agent/[token]/twiml" | "/api/webhook/call-status" | "/api/webhook/org/[token]/trigger-call" | "/api/webhook/outgoing-call" | "/api/webhook/trigger-call" | "/auth/callback"
